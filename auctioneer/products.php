						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								while($row=$products->fetch_assoc()):
									$get = $conn->query("SELECT * FROM bids where product_id = {$row['id']} order by bid_amount asc limit 1 ");
								...
								<tr data-id= '<?php echo $row['id'] ?>'>
									...
									<td>
										 <p><small>Measurment: <b><?php echo ucwords($row['measurement'],2) ?></b></small></p>
										 <p><small>Bid-Form Price: <b><?php echo number_format($row['price_for_form'],2) ?></b></small></p>
